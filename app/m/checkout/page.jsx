...
export default function CheckoutPage(){
    ...
    if (dataPanier) {
        ...
        const listPanier = dataPanier[0].detailDocuments.map(panier => <ItemArticleCheckout  key={panier['@id']} image={panier.produit.imageProduits[0].path} nom={panier.produit.nom}  prix={parseInt(panier.prixUnitaire)} qte={panier.quantite}></ItemArticleCheckout>)

        const listAdresse = dataAdresse.map(adresse => <option value={adresse["@id"]} key={adresse["@id"]}>{adresse.pays}, {adresse.ville}, {adresse.commune} {adresse.description}</option>)
                ...
                <div className="mt-3 flex gap-5  flex-col lg:flex-row">
                    <div className="w-full min-h-[250px]">
                        ...
                        <div className="flex flex-col bg-slate-50 rounded-md p-5 gap-3">
                            <div className="flex items-center">
                                ...
                                <div className="font-bold text-base ml-2">Adresse de livraison</div>
                            ...
                            <div>
                                <select onChange={(e)=>updateAdresseLivraison(e.target.value)} className="md:w-[500px] w-full text-base px-1 py-2">
                                    {listAdresse}
                                </select>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col mt-5 bg-slate-50 rounded-md p-5 gap-3">
                            <div className="flex items-center">
                                ...
                                <div className="font-bold text-base ml-2">Récapitulatif des articles</div>
                        ...
                        <div className="text-center mt-5"><Link href={"/m/panier"} className="text-rouge text-base">modifier le panier</Link></div>
                    ...
                    <div className="  border rounded-lg border-gray-200 px-3 py-5 h-fit ">
                        ...
                        <div className="w-full mt-5 flex ">
                            ...
                            <button className="bg-black text-white px-3 text-base ml-2">SOUMETTRE</button>
                        </div>
