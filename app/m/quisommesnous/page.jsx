        ...
        <div className="px-20 mt-20">
            ...
            <div className="flex justify-center items-center ">
                ...
                <div className="w-1/2 flex justify-center items-center">
                    <img loading="lazy" width={300} srcSet={logo}></img>
                </div>
            </div>
            ...
            <div className="flex justify-center mt-8 gap-20">
                <div className="w-1/3 mt-8">
                    ...
                    <div className="mb-5">
                        <input className="outline-0 text-base bg-slate-100 rounded-md py-2 px-2 w-[400px]"></input>
                    </div>
                    <div className="w-full">
                        <textarea className="outline-0 text-base bg-slate-100 rounded-md py-2 px-2 w-[400px]" rows="5" >
                            votre message
                        </textarea>
                    </div>
                    <button className="mt-6 text-base w-[400px] bg-jaune text-center py-2.5 rounded-md mb-2 ">Valider</button>
                </div>

                <div className="w-2/3 mt-16 flex justify-center items-center">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3972.8552746710984!2d-3.9634558261238433!3d5.285267536315043!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfc1ef5ea512a9f5%3A0xa9fd57d7eb0e72a!2sAgence%20Moses%20Art!5e0!3m2!1sfr!2sci!4v1709169364090!5m2!1sfr!2sci"  height="450" className="border-0 w-full" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    )
