            ...
            <div className="flex items-center bg-white justify-between px-1 py-1 h-[35%]">
                <div className="flex  flex-col px-1">
                    <div className="flex flex-col items-center">
                        <div className="font-bold w-fit px-2 py-1 mb-1 bg-jaune md:text-[11px] min-[1210px]:text-[12px] rounded-[5px] ">3500 <span className="text-[10px]">FCFA</span></div>
                        <div className="font-bold w-fit  py-1 md:text-[11px] min-[1210px]:text-[12px] ">5800 <span className="text-[10px]">FCFA</span></div>
                        </div>
