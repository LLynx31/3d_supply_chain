...
export async function sendCode(isEmail){
    ...
    try {
      const response = await fetch("https://api.3dsupplychains.com/api/users/send_reset_code",{
        method: "POST",
  ...
  export async function verifyCode(dataForm){
    try {
      const response = await fetch("https://api.3dsupplychains.com/api/users/verify_reset_code",{
        method: "POST",
